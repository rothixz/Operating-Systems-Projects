/**
 *  \file mount_sofs15.c (implementation file)
 *
 *  \brief The SOFS15 mounting tool.
 *
 *  It provides a simple method to integrate the SOFS15 file system into Linux.
 *
 *  SINOPSIS:
 *  <P><PRE>                mount_sofs15 [OPTIONS] supp-file mount-point
 *
 *               OPTIONS:
 ...
 *  \author António Rui Borges - October 2010 / October 2015
 */
...
int main(int argc, char *argv[])
{
  ...
  char *fuse_argv[] = { argv[0], argv[optind+1],
                        /* "-s", */
                        "-o", "nonempty",
                        "-o", "fsname=SOFS15", "-o", "subtype=ext-like",
