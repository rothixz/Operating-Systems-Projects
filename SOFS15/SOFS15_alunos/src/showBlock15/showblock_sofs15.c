/**
 *  \file showblock_sofs15.c (implementation file)
 *
...
int main (int argc, char *argv[])
{
  ...
  if ((opt = getopt (argc, argv, "x:X:a:A:b:B:s:i:T:D:r:R:h")) == -1)
  ...
  { case 'x': /* show the block contents as hexadecimal data */
    ...
    case 'D': /* show the cluster contents as a sub-array of directory entries */
              ...
              break;
    case 'r': /* show the block contents as a sub-array of data cluster references */
              isCluster = false;
              print2 = printCltRef;
